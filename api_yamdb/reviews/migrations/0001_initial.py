# Generated by Django 3.2 on 2023-02-06 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256)),
                ('year', models.PositiveSmallIntegerField(db_index=True, validators=[reviews.validators.YearValidator()])),
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('change_own_review', 'Can change own review'), ('delete_own_review', 'Can delete own review')],
            },
        ),
        migrations.CreateModel(
            name='Comment',
            ...
            options={
                'permissions': [('change_own_comment', 'Can change own comment'), ('delete_own_comment', 'Can delete own comment')],
            },
        ),
